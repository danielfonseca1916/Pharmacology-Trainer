...
export default function MOAModule() {
  ...
  const prev = () => {
    setIndex((i) => (i - 1 + drugs.length) % drugs.length);
    setRevealed(false);
  };
    ...
    <div className="max-w-3xl mx-auto p-6">
      ...
      <div className="bg-white shadow rounded p-6">
        ...
        <div className="mb-4">
          ...
          {!revealed ? (
            ...
            <div className="p-4 bg-green-50 border rounded">
              {language === "en" ? current.mechanism.en : current.mechanism.cs}
            </div>
          )}
        </div>
        <div className="flex gap-2">
          ...
          <button onClick={prev} className="px-4 py-2 bg-gray-800 text-white rounded">
            Prev
          </button>
